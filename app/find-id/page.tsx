  ...
  return (
    <div className="min-h-dvh bg-white flex flex-col">
      ...
      <div className="flex items-center gap-2 px-4 h-14 border-b border-[#f5f5f7]">
        ...
        <h1 className="text-[18px] font-bold text-[#1d1d1f]">아이디 찾기</h1>
      </div>
        ...
        {step === "input" && (
          <>
            <div className="mb-8">
              ...
              <p className="text-[15px] text-[#6e6e73] mt-2">본인 인증 후 아이디를 확인할 수 있어요</p>
            </div>
        ...
        {step === "result" && (
          <div className="flex flex-col items-center text-center pt-6">
            ...
            <p className="text-[14px] text-[#6e6e73] mb-6">
              검단 라이프는 <span className="font-bold text-[#1d1d1f]">휴대폰 번호</span>로 로그인해요
            </p>
            ...
            <div className="w-full flex flex-col gap-3">
              ...
              <Link href="/find-password/"
                className="w-full h-[52px] rounded-xl bg-[#f5f5f7] text-[#424245] text-[16px] font-bold flex items-center justify-center active:opacity-70 transition-opacity">
                비밀번호 찾기
              </Link>
            </div>
          </div>
