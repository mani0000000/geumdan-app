      ...
      <div className="flex-1 px-6 pt-8 flex flex-col">
        {step === "input" && (
          <>
            <div className="mb-8">
              ...
              <p className="text-[14px] text-[#8B95A1] mt-2">본인 인증 후 아이디를 확인할 수 있어요</p>
            </div>
            <div className="flex gap-2 mb-3">
              ...
              <button
                ...
                className="h-[52px] px-4 rounded-xl bg-[#3182F6] text-white text-[13px] font-bold whitespace-nowrap disabled:opacity-40 active:bg-[#1B64DA] transition-colors"
              >
            ...
            {codeSent && (
              <>
                ...
                <p className="text-[12px] text-[#3182F6] mb-4">인증번호가 발송됐어요 (유효시간 3분)</p>
              </>
            )}
        ...
        {step === "result" && (
          <div className="flex flex-col items-center text-center pt-6">
            ...
            <h2 className="text-[22px] font-bold text-[#191F28]">아이디를 찾았어요</h2>
            <p className="text-[14px] text-[#8B95A1] mt-2 mb-8">{phone} 로 가입된 계정이에요</p>

            <div className="w-full bg-[#F2F4F6] rounded-2xl px-6 py-5 mb-8">
              <p className="text-[13px] text-[#8B95A1] mb-2">가입된 아이디</p>
              <p className="text-[22px] font-black text-[#3182F6]">{maskedId}</p>
              <p className="text-[12px] text-[#B0B8C1] mt-2">보안을 위해 일부 번호는 가려져요</p>
            </div>
