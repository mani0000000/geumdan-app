...
function StarRating({ rating }: { rating: number }) {
  return (
    <div className="flex gap-0.5">
      {[1, 2, 3, 4, 5].map(i => (
        <Star key={i} size={13} className={i <= rating ? "text-[#FFBB00] fill-[#FFBB00]" : "text-[#E5E8EB]"} />
      ))}
    </div>
  );
}
...
function DetailContent() {
  ...
  return (
    <div className="min-h-dvh bg-[#F2F4F6]">
      {/* Header */}
      <div className="flex items-center justify-between px-4 h-14 bg-white sticky top-0 z-10 border-b border-[#F2F4F6]">
      ...
      <div className="pb-8 space-y-3">
        ...
        <div className="bg-white px-5 py-5">
          ...
          <div className="space-y-2.5">
            ...
            {store.phone && (
              <div className="flex items-center justify-between bg-[#F2F4F6] rounded-xl px-4 py-3">
        ...
        <div className="bg-white px-5 py-4">
          ...
          {reviews.length > 0 ? (
            <div className="space-y-3">
              {reviews.map((r, i) => (
                <div key={i} className={`pb-3 ${i < reviews.length - 1 ? "border-b border-[#F2F4F6]" : ""}`}>
