...
const APT_MASTER = [
  ...
  // ── 아라지구 (백석동) ──────────────────────────────────────────
  { id: 'apt11', name: '검암역 로열파크씨티 푸르지오 1단지', dong: '백석동', households: 2379, built: 2023,
    sizes: [{ pyeong: 24, sqm: 84 }, { pyeong: 34, sqm: 114 }] },
  { id: 'apt12', name: '검암역 로열파크씨티 푸르지오 2단지', dong: '백석동', households: 2426, built: 2023,
    sizes: [{ pyeong: 24, sqm: 84 }, { pyeong: 34, sqm: 114 }] },
  // ── 당하동 추가 ────────────────────────────────────────────────
  { id: 'apt16', name: '검단 한신더휴 어반파크',  dong: '당하동', households:  910, built: 2023,
    sizes: [{ pyeong: 24, sqm: 79 }, { pyeong: 34, sqm: 114 }] },
  // ── 불로동 추가 ────────────────────────────────────────────────
  { id: 'apt17', name: '제일풍경채 검단 1차',     dong: '불로동', households: 1425, built: 2024,
    sizes: [{ pyeong: 24, sqm: 84 }, { pyeong: 34, sqm: 114 }] },
  // ── 왕길동 추가 ────────────────────────────────────────────────
  { id: 'apt18', name: '왕길역 로열파크씨티 푸르지오', dong: '왕길동', households: 1500, built: 2024,
    sizes: [{ pyeong: 24, sqm: 84 }, { pyeong: 34, sqm: 114 }] },
];
