...
export const newsItems: NewsItem[] = [
  {
    id: "n1",
    type: "뉴스",
    title: "검단 신도시 지하철 2호선 연장 사업, 올해 착공 확정",
    summary:
      "인천시는 검단 신도시까지 이어지는 서울 지하철 2호선 연장 사업이 올해 하반기 착공될 예정이라고 밝혔다.",
    thumbnail: "/images/news1.jpg",
    source: "인천일보",
    publishedAt: "2026-03-28T08:00:00",
    url: "#",
    viewCount: 3421,
  },
  {
    id: "n2",
    type: "뉴스",
    title: "검단 SK뷰 센트럴 상업지구, 5월 입점 시작",
    summary:
      "검단 SK뷰 센트럴 상업지구가 오는 5월부터 순차적으로 입점을 시작한다. 대형 카페, 음식점, 편의시설 등이 들어설 예정이다.",
    thumbnail: "/images/news2.jpg",
    source: "경인일보",
    publishedAt: "2026-03-27T14:30:00",
    url: "#",
    viewCount: 2189,
  },
  {
    id: "n3",
    type: "유튜브",
    title: "검단 신도시 근황 브이로그 - 2026년 봄 업데이트",
    summary:
      "검단 신도시 주민 채널. 최근 개통된 상가와 공원 현황을 영상으로 담았습니다.",
  ...
  },
  {
    id: "n4",
    type: "뉴스",
    title: "인천 서구, 검단 공원 개발 사업 본격화",
    summary:
      "2027년 완공을 목표로 검단 중앙공원 개발 사업이 본격 추진된다. 야외 체육시설과 문화공간이 대폭 확충될 예정이다.",
  ...
  },
  {
    id: "n5",
    type: "인스타",
    title: "#검단맛집 주말 브런치 카페 모음 ☕",
    summary:
      "검단에 새로 오픈한 브런치 카페들을 소개합니다. 인테리어도 예쁘고 커피도 맛있어요!",
  ...
  },
  {
    id: "n6",
    type: "유튜브",
    title: "검단 아파트 단지 투어 - 당하동 vs 불로동 비교",
    summary:
      "검단 신도시 각 단지별 장단점을 직접 발로 뛰며 비교해봤습니다. 이사 고민하시는 분들 필시청!",
