...
export const DEFAULT_WIDGETS: WidgetConfig[] = [
  ...
  { id: "livefeed",   label: "실시간 피드",  enabled: true, sort_order: 10 },
  ...
  { id: "tides",      label: "서해안 조석·해루질·낚시", enabled: true, sort_order: 18 },
  { id: "gas",        label: "주유소 가격",  enabled: true, sort_order: 19 },
];
